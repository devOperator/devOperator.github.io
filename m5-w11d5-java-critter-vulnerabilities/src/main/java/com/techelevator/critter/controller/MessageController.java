...
//	@RequestMapping(path="/deletemessages", method=RequestMethod.GET)
//	public String deleteMessage(@PathVariable String userName,@RequestParam String messageId) {
//		
//		messageDAO.deletePublicMessage(messageId);
//		
//		return "redirect:/";
//	}
