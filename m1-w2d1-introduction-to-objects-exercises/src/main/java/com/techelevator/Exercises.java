...
public class Exercises {
	...
	public String theEnd(String str, boolean front) {
		return front? str.substring(0,1): str.substring(str.length() - 1); //notice substring(str.length) won't return anything
	}
	...
	public boolean endsLy(String str) {
		//return str.substring(str.length() - 1, str.length()).equals("ly");
	...
	public boolean hasBad(String str) {
		...
		else if(str.length() > 3 && (str.startsWith("bad") || str.substring(1, 4).equals("bad"))){
			return true;
		}
		else {
			return false;
	...
	public boolean doubleX(String str) {
		if(str.indexOf("x") != -1 && str.indexOf("x") != (str.length() - 1)) {
			if(str.substring(str.indexOf("x") + 1, str.indexOf("x") + 2).equals("x")) {
				return true;
			}else {
				return false;
			}
	...
	public String stringSplosion(String str) {
		String result = "";
			for(int i = 0; i < str.length(); i++) {
				int count = 0;
				result += str.substring(count, 1 + i + count);
				count = 0;
	...
	public int last2(String str) {
		...
		if(str.length() < 3) {
			...
			String matchCase = str.substring(str.length() - 2, str.length());
			
			for(int i = 0; i < str.length() - 2; i++) {
				if(str.substring(i,i+2).equals(matchCase)) {
					matchCount++;
				}
			}
		}
